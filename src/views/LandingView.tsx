...
const LandingView = () => {
  ...
  return (
    <div className="flex flex-col h-full mx-40 py-[32px] justify-center items-center">
      <nav className="w-full flex flex-row justify-between items-center items-stretch bg-background m">
        ...
        <div id="button-section" className="flex flex-start space-x-4">
          <button
            ...
            className="flex justify-center items-center p-4 w-24 border-2 rounded-3xl border-white text-white text-base font-normal font-['Poppins']"
          >
            About
          </button>
          <button
